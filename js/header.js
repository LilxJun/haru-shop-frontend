...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (currentUserJSON) {
        try {
            ...
            // ==========================================
            // LOGIC PHÂN QUYỀN ADMIN (KIỂM TRA ROLE TỪ DATABASE)
            // ==========================================
            // Xóa cái dòng check email cứng đi, dùng role cho bảo mật 100%

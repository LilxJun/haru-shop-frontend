...
const PRIZES = [
    { id: 'mouse', name: 'Chuot ATK Blazing Sky F1 Leviathan', type: 'mouse', weight: 0.5 },
    { id: 'v20', name: 'Voucher giam 20%', type: 'voucher', weight: 5, discount: 20 },
    { id: 'v15', name: 'Voucher giam 15%', type: 'voucher', weight: 10, discount: 15 },
    { id: 'v10', name: 'Voucher giam 10%', type: 'voucher', weight: 15, discount: 10 },
    { id: 'v5', name: 'Voucher giam 5%', type: 'voucher', weight: 20, discount: 5 },
    { id: 'none', name: 'Chuc ban may man lan sau', type: 'none', weight: 49.5 },
];
...
exports.checkGiveaway = async (req, res) => {
    ...
    try {
        ...
        console.error('ERROR checkGiveaway:', err.message);
